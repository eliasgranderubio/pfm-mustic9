...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="../wsdl/Slave_John_The_Ripper_Wrapper_WS.wsdl"/>
      <rootElement name="johnTheRipperAttack" namespace="http://ws.slave.cracking.uem.es/"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [THU APR 30 00:10:47 CEST 2015]. -->
?>
